...
class YourChannelStream extends YourChannelStreamAPI {
	...
	function siteInit(){
		...
		if( in_array($this->apikey, ['AIzaSyCEhi-95k6t1rX4pDVqugauM-UyTfNHj8Q', 'AIzaSyBYMmA9AqnfKJpkX-jORrgWrM4bkOhq3W4', 'AIzaSyA2s6HsqK4bEqCfnKqqbZcwm-FIskY026A']) ){
